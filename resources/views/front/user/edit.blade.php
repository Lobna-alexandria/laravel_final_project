...
<div class="col col-md-12 row d-flex align-items-center  justify-content-between">
  ...
  <div class=" col col-md-2 p-2 d-flex justify-content-center">
   <img id="img-preview" src="{{asset('uploads/users/'. $user->image) }}" width="300" height="300" class=" img-fluid" alt="User Photu">
  ...
  <label class="px-2">Role : </label>
   ...
   <div class="d-flex mx-2"> 
    <div class="form-check">
      <input  value="{{$role->name}}"  class="form-check-input" {{$user->hasRole($role->name) ? 'checked' : ''}}  type="radio" name="user_role">
...
<div class="d-flex  p-3">
  <label class="px-2">Permissions: </label>
   ...
   <div class="d-flex mx-2"> 
    <div class="form-check">
      <div class="form-check">
        <input value="{{$perm->name}}" class="form-check-input" type="checkbox" name="perms[]" {{$user->hasPermission($perm->name) ? 'checked' : ''}}>
