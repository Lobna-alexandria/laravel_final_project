            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about__image">
                        <img src="{{ asset('uploads/profile/'.$AlldataP[0]->image) }}"
                            alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="about__content">
                        ...
                        <div class="about__exp">
                            ...
                            <div class="about__exp__content">
                                <p><span>20+ Years Experience</span> {{ $AllAbt[0]->title }}</p>
                            </div>
                        </div>
                    ...
                    <div class="about__info__wrap">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="about" role="tabpanel"
                                ...
                                <div > {!! html_entity_decode($AllAbt[0]->editor1) !!}</div>
                                    ...
                                    <div class="row">
                                        @foreach ($AllSkills as $skill)
                                            ...
                                            <div class="about__skill__item">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar" role="progressbar" style="width: {{$skill->perc  }}%"
                                                        aria-valuenow="{{$skill->perc }}" aria-valuemin="0" aria-valuemax="100"><span
                                                            class="percentage">{{$skill->perc }}</span></div>
                                                </div>
                                            </div>
                                        </div>
                                        @endforeach
                                ...
                                <div class="about__award__wrap">
                                    <div class="row justify-content-center">
                                        <div class="col-md-6 col-sm-9">
                                            <div class="about__award__item">
                                                <div class="award__logo">
                                                    <img src="{{asset('frontDesign/img/images/awards_01.png')}}" alt="">
                                                </div>
                                        ...
                                        <div class="col-md-6 col-sm-9">
                                            <div class="about__award__item">
                                                <div class="award__logo">
                                                    <img src="{{asset('frontDesign/img/images/awards_02.png')}}" alt="">
                                                </div>
                                                <div class="award__content">
                                        ...
                                        <div class="col-md-6 col-sm-9">
                                            <div class="about__award__item">
                                                <div class="award__logo">
                                                    <img src="{{asset('frontDesign/img/images/awards_03.png')}}" alt="">
                                                </div>
                                                <div class="award__content">
                                        ...
                                        <div class="col-md-6 col-sm-9">
                                            <div class="about__award__item">
                                                <div class="award__logo">
                                                    <img src="{{asset('frontDesign/img/images/awards_04.png')}}" alt="">
                                                </div>
                                                <div class="award__content">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="services__style__two__item">
                            <div class="services__style__two__icon">
                                <img src="{{asset('frontDesign/img/icons/services_light')}}_icon01.png" alt="">
                            </div>
