...
<div class="card">
    <div class="card-header">
      ...
      <a href="{{route('service.create')}}" class="btn bg-olive mx-5">Add Services</a>

      @else
      <button disabled class="btn btn-secondary mx-5">Add Serv social icons</button>
    ...
    <div class="card-body">
      <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row">
        ...
        <tr role="row">
            ...
            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">list</th>
        ...
        <tbody>
         <tr role="row" class="odd">
          ...
          <td>{{$data->name}}</td>
          <td>{{$data->desc}}</td>
          <td><img src="{{asset('uploads/services/'.$data->image)}}" width="100" height="100" alt=""> </td>
          <td style="word-spacing: break-word">{!! html_entity_decode($data->editor1) !!} </td>
          ...
          <td>
             ...
             @if (Auth::user()->hasPermission('users-update'))
                 ...
                 <a href="{{route('service.edit',['service' => $data->id ])}}" class="btn bg-olive">Edit  </a>
            ...
            <form action="{{route('service.destroy',['service'=>$data->id])}}" method="POST">
              @csrf
              @method('DELETE')
