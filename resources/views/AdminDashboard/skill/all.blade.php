...
<div class="card">
    <div class="card-header">
      ...
      <a href="{{route('skill.create')}}" class="btn bg-olive mx-5">Add Skill</a>

      @else
      <button disabled class="btn btn-secondary mx-5">Add Skill</button>
    ...
    <div class="card-body">
      <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4"><div class="row">
        ...
        <tr role="row">
            ...
            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Percantage</th>
         ...
         <tr role="row" class="odd">
          ...
          <td>
             ...
             @if (Auth::user()->hasPermission('users-update'))
                 ...
                 <a href="{{route('skill.edit',['skill' => $data->id ])}}" class="btn bg-olive">Edit  </a>
            ...
            <form action="{{route('skill.destroy',['skill'=>$data->id])}}" method="POST">
              @csrf
              @method('DELETE')
